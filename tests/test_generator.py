...
class TestEndToEnd:
    ...
    def test_generated_code_works(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            (test_msgs / "Point.msg").write_text("float64 x\nfloat64 y\nfloat64 z\n")
            ...
            try:
                ...
                Pose = importlib.import_module("test_pkg.msg._pose").Pose
    ...
    def test_generated_with_builtins(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            sys.path.insert(0, str(out))
            try:
                Header = importlib.import_module("std_msgs.msg._header").Header
                assert Header
    ...
    def test_generated_service_wrapper_usable(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                ...
                assert (
                    _mod.AddTwoInts_Request.__ros_name__ == "pkg/srv/AddTwoInts_Request"
                )
                assert (
                    _mod.AddTwoInts_Response.__ros_name__
                    == "pkg/srv/AddTwoInts_Response"
                )
            finally:
                sys.path.pop(0)
    ...
    def test_generated_action_wrapper_usable(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            try:
                ...
                assert (
                    _mod.Do_SendGoal_Request.__ros_name__
                    == "pkg/action/Do_SendGoal_Request"
                )
            finally:
                sys.path.pop(0)
                for mod in list(sys.modules):
